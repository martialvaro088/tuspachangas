 ...
 */
class StaticApp extends webview_1.Webview {
    constructor() {
        super(...arguments);
    ...
    downloadSDK(callback, force = false) {
        ...
        if (!force && fs.existsSync(sdkFolder)) {
            ...
            console.log(GitListDir_1.getDownloadLink(this.sdk.user, this.sdk.repo));
            downloadsdk({
                url: GitListDir_1.getDownloadLink(this.sdk.user, this.sdk.repo, 'main'),
                repo: this.sdk.repo,
